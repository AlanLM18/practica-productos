...
class UsuarioBD extends ConectarBD{
    ...
    async editarUsuario(usuario){
        const sql = "update usuarios set nom_usuario = '"+usuario.nombre+"', cel_usuario = '"+usuario.celular+"', correo_usuario = '"+usuario.correo+"' where id_usuario= '"+usuario.id_usuario+"':";
        const sql1 = `update usuarios set nom_usuario ='${usuario.nombre}', cel_usuario ='${usuario.celular}', correo_usuario ='${usuario.correo}' where id_usuario ='${usuario.id_usuario}';`;
        try {
            await this.conectarMySql();
